...
export default function GuessingRound() {
  ...
  const submitContribution = () => {
    ...
    const roundData = {
      ...
      ai_guess: selectedEntry.aiGuess,
          ...
          <View className='page__body'>
            ...
            <View className='guessing__compare'>
              ...
              <View className='guessing__compare-item'>
                ...
                <Text className='guessing__compare-value guessing__compare-value--ai'>{selectedEntry!.aiGuess}</Text>
              </View>
            </View>
            <Text className='guessing__contribute-hint'>
              AI 猜错了！请你提供一个能帮助 AI 更好区分「{selectedEntry!.name}」和「{selectedEntry!.aiGuess}」的是/否问题（例如：「它是四条腿的吗？」）：
            </Text>
            <Input
